...
const { filteredList: displayedFiles, searchText: filterFilesSearchText } = useListFilter(currentFiles, (file) => file.name);
const { filteredList: displayedAllFiles, searchText: filterAllFilesSearchText } = useListFilter(allFiles, (file) => file.name);
const { filteredList: displayedVisas, searchText: filterVisasSearchText } = useListFilter(allVisas, (visa) => visa.document.name);

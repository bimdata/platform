...
const APP_BASE_URL = bimdata.env.VUE_APP_BASE_URL;
const AUTHORITY = `${bimdata.env.VUE_APP_IAM_BASE_URL}/auth/realms/bimdata`;
const OIDC_ENDPOINT = `${AUTHORITY}/protocol/openid-connect`;

const CLIENT_ID = bimdata.env.VUE_APP_OIDC_CLIENT_ID;
const AUTHORIZED_IDENTITY_PROVIDERS =
  bimdata.env.VUE_APP_AUTHORIZED_IDENTITY_PROVIDERS;

...
// Env variables
const SUBSCRIPTION_ENABLED = import.meta.env.VITE_SUBSCRIPTION_ENABLED;
const PADDLE_SANDBOX = import.meta.env.VITE_PADDLE_SANDBOX;
const PADDLE_VENDOR_ID = import.meta.env.VITE_PADDLE_VENDOR_ID;
const PRO_PLAN_ID = import.meta.env.VITE_PRO_PLAN_ID;
const DATAPACK_PLAN_ID = import.meta.env.VITE_DATAPACK_PLAN_ID;
const FREE_PLAN_STORAGE = import.meta.env.VITE_FREE_PLAN_STORAGE;
const PRO_PLAN_STORAGE = import.meta.env.VITE_PRO_PLAN_STORAGE;
